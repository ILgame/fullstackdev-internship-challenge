            ...
            >
              <v-row>
                <v-card-title class="coins">
                  <v-row>
                    <v-col lg="12">
                      <span class="mx-8">Insert : {{ coin }}</span></v-col
                    ></v-row
                  >
                  <v-row>
                    <v-col lg="12">
                      <h4>
                        <span class="mx-8">Totle : {{ totalCoin }}&#3647;</span>
                      </h4></v-col
                    ></v-row
                  >
                  <v-row>
                    <v-col lg="12">
                      <h4>
                        <span class="mx-8">Change : {{ changeCoin }}</span>
                      </h4></v-col
                    ></v-row
                  >
                  <v-row>
                    <v-col lg="12">
                      <h4>
                        <span class="mx-8">Selected : {{ productName }}</span>
                      </h4></v-col
                    ></v-row
                  >
                </v-card-title>
